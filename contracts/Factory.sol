...
contract Factory is IFactory {
    ...
    IAriesPriceOracle public ariesPriceOracle;
    ...
    constructor(
        ...
        IAriesPriceOracle _ariesPriceOracle
    ) public {
        admin = _admin;
    ...
    function createCollateral(address uniswapV2Pair) external returns (address collateral) {
        ...
        require(getLendingPool[uniswapV2Pair].collateral == address(0), "Aries: ALREADY_EXISTS");
    ...
    function createBorrowable0(address uniswapV2Pair) external returns (address borrowable0) {
        _getTokens(uniswapV2Pair);
        require(getLendingPool[uniswapV2Pair].borrowable0 == address(0), "Aries: ALREADY_EXISTS");
    ...
    function createBorrowable1(address uniswapV2Pair) external returns (address borrowable1) {
        _getTokens(uniswapV2Pair);
        require(getLendingPool[uniswapV2Pair].borrowable1 == address(0), "Aries: ALREADY_EXISTS");
    ...
    function initializeLendingPool(address uniswapV2Pair) external {
        ...
        require(!lPool.initialized, "Aries: ALREADY_INITIALIZED");

        require(lPool.collateral != address(0), "Aries: COLLATERALIZABLE_NOT_CREATED");
        require(lPool.borrowable0 != address(0), "Aries: BORROWABLE0_NOT_CREATED");
        require(lPool.borrowable1 != address(0), "Aries: BORROWABLE1_NOT_CREATED");

        (, , , , , bool oracleInitialized) = ariesPriceOracle.getPair(uniswapV2Pair);
        if (!oracleInitialized) ariesPriceOracle.initialize(uniswapV2Pair);

        ICollateral(lPool.collateral)._initialize("Aries Collateral", "cARIES", uniswapV2Pair, lPool.borrowable0, lPool.borrowable1);
        IBorrowable(lPool.borrowable0)._initialize("Aries Borrowable", "bARIES", token0, lPool.collateral);
        IBorrowable(lPool.borrowable1)._initialize("Aries Borrowable", "bARIES", token1, lPool.collateral);
    ...
    function _setPendingAdmin(address newPendingAdmin) external {
        require(msg.sender == admin, "Aries: UNAUTHORIZED");
    ...
    function _acceptAdmin() external {
        require(msg.sender == pendingAdmin, "Aries: UNAUTHORIZED");
    ...
    function _setReservesPendingAdmin(address newReservesPendingAdmin) external {
        require(msg.sender == reservesAdmin, "Aries: UNAUTHORIZED");
    ...
    function _acceptReservesAdmin() external {
        require(msg.sender == reservesPendingAdmin, "Aries: UNAUTHORIZED");
